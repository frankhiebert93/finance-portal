...
export default async function SettingsPage() {
    ...
    // Server Action: Update category limit AND name
    async function updateCategory(formData: FormData) {
        ...
        await supabase.from('categories').update({ name, monthly_limit: Number(limit) }).eq('id', id)
        revalidatePath('/dashboard/settings')
        revalidatePath('/dashboard/personal')
        revalidatePath('/dashboard/transactions')
    }

    // Server Action: Add a brand new category
    ...
    // Server Action: Update custom savings buckets
    ...
    // Server Action: Add a new debt profile
    ...
    // Server Action: Update an existing debt profile
    ...
    return (
        <div className="max-w-3xl mx-auto p-4 md:p-8 space-y-6">
            ...
            {/* Monthly Category Limits & Names (EDITABLE) */}
